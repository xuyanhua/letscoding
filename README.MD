...
# 数据结构
## 数组
+ 找出重复的元素：[FindDuplicateElement](datastructure/src/main/java/com/yanhua/datastructure/array/O03_1_FindDuplicateElement.java)
+ 不修改数组查找重复的元素：[FindDuplicateElementWithNoModify](datastructure/src/main/java/com/yanhua/datastructure/array/O03_2_FindDuplicateElementWithNoModify.java)
+ 在二维数组中查找指定元素是否存在：[FindIn2DArray](datastructure/src/main/java/com/yanhua/datastructure/array/O04_FindIn2DArray.java)
